<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/auth/loan')) }}" href="{{ route('admin.auth.loan.index') }}">
                    <i class="nav-icon icon-cursor"></i> Loans
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/auth/book')) }}" href="{{ route('admin.auth.book.index') }}">
                    <i class="nav-icon icon-notebook"></i> Books
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/auth/terminal')) }}" href="{{ route('admin.auth.terminal.index') }}">
                    <i class="nav-icon icon-bag"></i> Terminals
                </a>
            </li>
